...
janusgraph_bin_dir = janusgraph_install_dir + '/bin'
janusgraph_data_dir = janusgraph_install_dir + '/data'
# JanusGraph configurations
janusgraph_conf_dir = janusgraph_install_dir + '/conf'
...
janusgraph_server_conf_dir = janusgraph_install_dir  + "/conf/gremlin-server"
...
janusgraph_home_dir = janusgraph_install_dir 
janusgraph_conf_dir = janusgraph_install_dir  + '/conf'
janusgraph_conf_hadoop_graph_dir = janusgraph_install_dir  + '/conf/hadoop-graph'
janusgraph_data_dir = janusgraph_install_dir + '/data'
...
janusgraph_ext_spark_plugin_dir = janusgraph_install_dir  + '/ext/spark-client/plugin'
...
janusgraph_dir = janusgraph_install_dir 
janusgraph_ext_dir = janusgraph_install_dir  + '/ext'
janusgraph_solr_conf_dir = janusgraph_install_dir  +  '/conf/solr'
